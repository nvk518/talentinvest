...
const studentData = [["John Smith", "https://images.pexels.com/photos/1438081/pexels-photo-1438081.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", "UC Berkeley", "5,000", 3], ["Steve Lobs", "https://images.pexels.com/photos/2325729/pexels-photo-2325729.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", "Stanford", "12,000", 6], ["Michelle Chen", "https://images.pexels.com/photos/207569/pexels-photo-207569.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", "Harvard", "15,000", 2], ["Laura Gutierrez", "https://images.pexels.com/photos/4947741/pexels-photo-4947741.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500", "UCSD", "10,000", 0], ["Sanjay Patel", "https://images.pexels.com/photos/3215733/pexels-photo-3215733.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260", "University of Michigan", "4,000", 6]]
                ...
                <GridList className={gridClasses.gridList} cols={4.5} spacing={20}>
                    {[studentData][0].map((tile) => (
                        <GridListTile>
                            ...
                            actionItem={
                                <IconButton aria-label={`info about ${tile[0]}`} className={gridClasses.icon}>
                                    <InfoIcon />
                                </IconButton>
                            }
                            />
